...
describe('reducer', () => {
    ...
    describe('should define a default a state', () => {
        ...
        it('that has a "players" key pointing to an instance of Immutable.Map', () => {
            expect(state.get('players')).to.be.an.instanceof(Immutable.Map);
        });

        it('that has a "spectators" key pointing to an instance of Immutable.Map', () => {
            expect(state.get('spectators')).to.be.an.instanceof(Immutable.Map);
        });

        it('that has a "world" key pointing to an instance of Immutable.Map', () =>  {
            expect(state.get('world')).to.be.an.instanceof(Immutable.Map);
        });

        it('where the "world" Immutable.Map has a key "map" pointing to an Immutable.List representing a 6x6 grid', () => {
